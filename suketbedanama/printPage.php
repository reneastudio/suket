...
$query = "SELECT nomor_surat FROM nomor_register WHERE nama_surat = 'suket_beda_nama' LIMIT 1";
$result = $conn->query($query);
$nomor_suket_beda_nama = $result->num_rows > 0 ? $result->fetch_assoc()['nomor_surat'] : '';
        ...
        <div class="row form-bg">
            <div class="col border border-0">
                ...
                <div id="pdf-content" class="padding-5mm">
                    ...
                    <p class="nomor-register">Nomor: <span class="preserve-spaces"><?php echo htmlspecialchars($nomor_suket_beda_nama); ?></span></p>
                    <div class="row isi-surat">
                        <div class="col">
                            ...
                            <p>Bahwa yang bersangkutan di atas terdapat kesalahan/perbedaan penulisan nama. <span class="nama_usaha garis-bawah"></span>.</p>

                            <p>Bersama ini menerangkan bahwa <span class="keterangan_usaha garis-bawah"></span> adalah 1 (satu) orang yang sama.
