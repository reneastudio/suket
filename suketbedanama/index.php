        ...
        <form class="needs-validation" action="printPage.php" method="GET" novalidate>
            <div class="row form-bg rounded">
                <div class="col-sm-5 col-md-5 col-xs-5 col-lg-5 p-4">
                    ...
                    <br>
                    <h5 class="form-heading"><strong>Data Beda Nama</strong></h5>
                    <div class="form-group">
                        <label>Terangkan letak kesalahan/perbedaan nama di dokumen</label>
                        <textarea type="textarea" placeholder="Contoh: Di KK tertulis Djoko. Di e-KTP tertulis Joko." name="nama_usaha" id="nama_usaha" class="form-control" cols="100" rows="4" required></textarea>
                        <div class="invalid-feedback">
                            Isi dengan keterangan
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Terangkan nama-nama di dokumen</label>
                        <input type="text" name="keterangan_usaha" id="keterangan_usaha" class="form-control"
                            placeholder="Contoh: Djoko di KK dan Joko di e-KTP" value="" required>
                        <div class="invalid-feedback">
                            Isi dengan nama berbeda di dokumen
                        </div>
                    </div>
                </div>
