...
// Ambil nomor surat untuk suket_domisili
$query = "SELECT nomor_surat FROM nomor_register WHERE nama_surat = 'suket_janda_duda' LIMIT 1";
$result = $conn->query($query);
$nomor_suket_janda_duda = $result->num_rows > 0 ? $result->fetch_assoc()['nomor_surat'] : '';
        ...
        <div class="row form-bg">
            <div class="col border border-0">
                ...
                <div id="pdf-content" class="padding-5mm">
                    ...
                    <p class="nomor-register">Nomor: <span class="preserve-spaces"><?php echo htmlspecialchars($nomor_suket_janda_duda); ?></span></p>
