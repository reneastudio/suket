...
function populateForm(data) {
    ...
    document.getElementById("nik_anak").value = data.nik_anak;
    document.getElementById("penghasilan_ortu").value = data.penghasilan_ortu;
}
...
function printData() {
    ...
    var nik_anak = document.getElementById("nik_anak").value;
    var penghasilan_ortu = document.getElementById("penghasilan_ortu").value;
