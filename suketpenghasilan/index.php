        ...
        <form class="needs-validation" action="printPage.php" method="GET" novalidate>
            <div class="row form-bg rounded">
                <div class="col-sm-5 col-md-5 col-xs-5 col-lg-5 p-4">
                    ...
                    <br>
                    <h5 class="form-heading"><strong>Data Anak</strong></h5>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan_usaha" id="keterangan_usaha" class="form-control"
                            placeholder="Contoh: Universitas Lumajang" value="" required>
                        <div class="invalid-feedback">
                            Isi dengan keterangan nama institusi pendidikan
                        </div>
                    </div>
                    <div class="form-group">
                        <label>NIK / Nomor KTP Anak</label>
                    ...
                    <br>
                    <h5 class="form-heading"><strong>Data Penghasilan</strong></h5>
                    <div class="form-group">
                        <label>Besar Penghasilan Orang Tua Per Bulan</label>
                        <input type="text" name="penghasilan_ortu" id="penghasilan_ortu" class="form-control"
                            placeholder="Contoh: 1.000.000 (Satu juta rupiah)" value="" required>
                        <div class="invalid-feedback">
                            Isi dengan keterangan besar penghasilan orang tua per bulan
                        </div>
                    </div>
                </div>
