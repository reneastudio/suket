...
$result = $conn->query($query);
$nomor_suket_skck = $result->num_rows > 0 ? $result->fetch_assoc()['nomor_surat'] : '';
        ...
        <div class="row form-bg">
            <div class="col border border-0">
                ...
                <div id="pdf-content" class="padding-5mm">
                    ...
                    <h4>Surat Pengantar Pengurusan SKCK</h4>
                    <p class="nomor-register">Nomor: <span class="preserve-spaces"><?php echo htmlspecialchars($nomor_suket_skck); ?></span></p>
                    <div class="row isi-surat">
                        <div class="col">
                            ...
                            <p>Yang bersangkutan di atas adalah benar-benar Penduduk Desa <span class="nama_desa"></span> Kecamatan <span class="data_kecamatan"></span> Kabupaten <span class="data_kabupaten"></span>. Berdasarkan catatan yang ada serta sepengetahuan kami, yang bersangkutan:<p>

                            <p class="nomor-urut mb-0">1. Berkelakuan baik, tidak pernah melakukan tindakan/perbuatan yang menyimpang atau norma sosial yang berlaku;</p>
                            <p class="nomor-urut mb-1">2. Tidak bersangkut paut perkara kriminal</p>
                            <p class="nomor-urut mb-2">3. Tidak dalam status tahanan yang berwajib</p>
                            <p class="nomor-urut mb-3">4. Tidak terlibat dalam penggunaan narkoba</p>
                            
                            <p>Surat Keterangan ini dibuat untuk "<span class="keterangan_usaha garis-bawah"></span>". Demikian Surat Keterangan ini dibuat agar dapat dipergunakan sebagaimana mestinya.</p>
