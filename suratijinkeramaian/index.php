        ...
        <form class="needs-validation" action="printPage.php" method="GET" novalidate>
            <div class="row form-bg rounded">
                <div class="col-sm-5 col-md-5 col-xs-5 col-lg-5 p-4">
                    ...
                    <br>
                    <h5 class="form-heading"><strong>Data Kegiatan</strong></h5>
                    <div class="form-group">
                        <label>Nama Kegiatan</label>
                        <input type="text" name="nama_usaha" id="nama_usaha" class="form-control"
                            placeholder="Contoh: Pernikahan" value="" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tanggal_kegiatan" id="tanggal_kegiatan" class="form-control" placeholder="Contoh: 23 - 25 Juli 2025" value="" required>
                        <div class="invalid-feedback">
                            Isi dengan tanggal kegiatan
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Lokasi Kegiatan</label>
                        <input type="text" name="lokasi_kegiatan" id="lokasi_kegiatan" class="form-control"
                            placeholder="Contoh: Rumah Bapak/Ibu ABCD" value="" required>
                        <div class="invalid-feedback">
                            Isi dengan keterangan lokasi kegiatan
                        </div>
                    </div>
                </div>
