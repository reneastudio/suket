...
window.onload = function () {
    ...
    if (dataString) {
        ...
        setValueByClassName('tanggal_kegiatan', dataArray[16]);
        setValueByClassName('lokasi_kegiatan', dataArray[17]);
...
function convertToPDFAndEmail() {
    ...
    const filename = `Surat_Ijin_Keramaian_${sanitizedNamaLengkap}.pdf`;
