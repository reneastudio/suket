...
function clearForm() {
    ...
    document.getElementById("tanggal_kegiatan").value = "";
...
function printData() {
    ...
    var tanggal_kegiatan = document.getElementById("tanggal_kegiatan").value;
    var lokasi_kegiatan = document.getElementById("lokasi_kegiatan").value;
