...
$query = "SELECT nomor_surat FROM nomor_register WHERE nama_surat = 'suket_keramaian' LIMIT 1";
$result = $conn->query($query);
$nomor_suket_keramaian = $result->num_rows > 0 ? $result->fetch_assoc()['nomor_surat'] : '';
...
$tanggal_kelahiran_url = $data_values[17] ?? '';
$lokasi_kelahiran_url = $data_values[18] ?? '';
        ...
        <div class="row form-bg">
            <div class="col border border-0">
                ...
                <div id="pdf-content" class="padding-5mm">
                    ...
                    <h4>Surat Ijin Keramaian</h4>
                    <p class="nomor-register">Nomor: <span class="preserve-spaces"><?php echo htmlspecialchars($nomor_suket_keramaian); ?></span></p>
                    <div class="row isi-surat">
                        <div class="col">
                            ...
                            <p>Yang bersangkutan di atas mengajukan ijin untuk mengadakan :</p>
                            <dl>
                                <dt>Nama Kegiatan:</dt>
                                <dd><span class="nama_usaha"></span></dd>
        
                                <dt>Tanggal :</dt>
                                <dd><span class="tanggal_kegiatan"></span></dd>

                                <dt>Lokasi :</dt>
                                <dd><span class="lokasi_kegiatan"></span></dd>
                            </dl>
