...
// Ambil nomor surat untuk suket_kehilangan
$query = "SELECT nomor_surat FROM nomor_register WHERE nama_surat = 'suket_kehilangan' LIMIT 1";
$result = $conn->query($query);
$nomor_suket_kehilangan = $result->num_rows > 0 ? $result->fetch_assoc()['nomor_surat'] : '';
        ...
        <div class="row form-bg">
            <div class="col border border-0">
                ...
                <div id="pdf-content" class="padding-5mm">
                    ...
                    <p class="nomor-register">Nomor: <span class="preserve-spaces"><?php echo htmlspecialchars($nomor_suket_kehilangan); ?></span></p>
                    <div class="row isi-surat">
                        <div class="col">
                            ...
                            <p>Bersama ini menerangkan bahwa yang bersangkutan di atas telah kehilangan <span class="keterangan_usaha garis-bawah"></span> dan sampai saat ini belum ditemukan.
