...
// Ambil nomor surat untuk suket_usaha
$query = "SELECT nomor_surat FROM nomor_register WHERE nama_surat = 'suket_usaha' LIMIT 1";
$result = $conn->query($query);
$nomor_suket_usaha = $result->num_rows > 0 ? $result->fetch_assoc()['nomor_surat'] : '';
        ...
        <div class="row form-bg">
            <div class="col border border-0">
                ...
                <div id="pdf-content" class="padding-5mm">
                    ...
                    <p class="nomor-register">Nomor: <span class="preserve-spaces"><?php echo htmlspecialchars($nomor_suket_usaha); ?></span></p>
                    <div class="row isi-surat">
                        <div class="col">
                            ...
                            <p>Yang bersangkutan di atas adalah benar-benar Penduduk Desa <span class="nama_desa"></span> Kecamatan <span class="data_kecamatan"></span> Kabupaten <span class="data_kabupaten"></span>. Surat Keterangan ini dibuat untuk menerangkan bahwa data yang tersebut di atas memang benar memiliki usaha "<span class="keterangan_usaha garis-bawah"></span>" dengan nama "<span class="nama_usaha garis-bawah"></span>" yang terletak di Desa <span class="nama_desa garis-bawah"></span> Kecamatan <span class="data_kecamatan garis-bawah"></span> Kabupaten <span class="data_kabupaten garis-bawah"></span></span>.</p>
