        ...
        <form class="needs-validation" action="printPage.php" method="GET" novalidate>
            <div class="row form-bg rounded">
                <div class="col-sm-5 col-md-5 col-xs-5 col-lg-5 p-4">
                    ...
                    <br>
                    <h5 class="form-heading"><strong>Tujuan Domisili</strong></h5>
                    <div class="form-group">
                        <label>Alamat Lengkap Tujuan Domisili</label>
                        <input type="text" name="keterangan_usaha" id="keterangan_usaha" class="form-control"
                            placeholder="Contoh: Jalan - RT/RW - Desa - Kecamatan - Kabupaten - Propinsi" value="" required>
                        <div class="invalid-feedback">
                            Isi dengan alamat lengkap tujuan domisili
                        </div>
                    </div>
                </div>
