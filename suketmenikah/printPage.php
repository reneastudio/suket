...
// Ambil nomor surat untuk suket_menikah
$query = "SELECT nomor_surat FROM nomor_register WHERE nama_surat = 'suket_menikah' LIMIT 1";
$result = $conn->query($query);
$nomor_suket_menikah = $result->num_rows > 0 ? $result->fetch_assoc()['nomor_surat'] : '';
        ...
        <div class="row form-bg">
            <div class="col border border-0">
                ...
                <div id="pdf-content" class="padding-5mm">
                    ...
                    <p class="nomor-register">Nomor: <span class="preserve-spaces"><?php echo htmlspecialchars($nomor_suket_menikah); ?></span></p>
                    <div class="row isi-surat">
                        <div class="col">
                            ...
                            <p>Yang bersangkutan di atas adalah benar-benar Penduduk Desa <span class="nama_desa"></span> Kecamatan <span class="data_kecamatan"></span> Kabupaten <span class="data_kabupaten"></span>. Berdasarkan pengamatan dan catatan kami, yang bersangkutan memang benar <span class="garis-bawah">Telah Menikah</span> dengan :</p>
                            
                            <dl>
                                <dt>Nama :</dt>
                                <dd><span class="nama_usaha garis-bawah"></span></dd>
